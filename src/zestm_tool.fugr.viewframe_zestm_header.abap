*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZESTM_HEADER
*   generation date: 01.07.2020 at 08:27:58
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZESTM_HEADER        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZESTM_HEADER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZESTM_HEADER_EXTRACT
TOTAL = ZESTM_HEADER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZESTM_HEADER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZESTM_HEADER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESTM_HEADER_EXTRACT
TOTAL = ZESTM_HEADER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZESTM_HEADER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZESTM_HEADER'
...
TOTAL = ZESTM_HEADER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZESTM_HEADER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZESTM_HEADER-UPD_FLAG NE SPACE.
