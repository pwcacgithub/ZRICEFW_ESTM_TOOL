*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZESTM_ITEM
*   generation date: 01.07.2020 at 09:06:25
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZESTM_ITEM          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZESTM_ITEM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZESTM_ITEM_EXTRACT
TOTAL = ZESTM_ITEM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZESTM_ITEM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZESTM_ITEM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESTM_ITEM_EXTRACT
TOTAL = ZESTM_ITEM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZESTM_ITEM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZESTM_ITEM'
...
TOTAL = ZESTM_ITEM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZESTM_ITEM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZESTM_ITEM-UPD_FLAG NE SPACE.
